...
export interface paths {
    ...
    "/requests/{requestId}/releases/refresh": {
         ...
         *
         *     A re-grab reads the replacement torrent's file list and reconciles the
         *     release's stored files with it: files the release already had keep their
         *     mappings, files new to the replacement are added unmapped and then
         *     automapped on their own. A replacement that does not carry a file the
         *     release already has is refused - nothing is queued or rewritten - and
         *     the release is flagged instead. A replacement whose file list cannot be
         *     read (a magnet-only result) is downloaded without that reconciliation.
         */
    ...
    "/settings/options/quality-profiles/{integration}": {
        ...
        /**
         * List an *arr's quality profiles
         * @description The quality profiles Sonarr or Radarr has configured, so the profile setting can be picked from a list rather than typed as a bare id.
         */
        get: operations["listQualityProfileOptions"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/settings/options/indexer-categories": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * List the categories the indexers accept
         * @description Prowlarr reports categories per indexer as a two-level tree; this merges both levels across every indexer and deduplicates by id.
         */
        get: operations["listIndexerCategoryOptions"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/settings/options/download-categories": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * List the download client's categories
         * @description The category names qBittorrent already has.
         */
        get: operations["listDownloadCategoryOptions"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        RequestWarningCode: "mapping_overlap" | "regrab_indexer_unavailable" | "release_not_listed" | "regrab_files_unmapped" | "regrab_files_missing";
        ...
        /** @description A warning as it appears on a release. `mapping_overlap` populates `file_ids`/`related_release_ids`; `regrab_indexer_unavailable` and `release_not_listed` leave both empty and put their own detail in `details` instead - a reason string for the first, the indexer that dropped the release for the second. `regrab_files_unmapped` and `regrab_files_missing` leave both empty too and carry a file count, the first naming the files automapping could not resolve and the second the files the replacement torrent does not contain. */
        ReleaseWarning: {
            code: components["schemas"]["RequestWarningCode"];
        ...
        QualityProfilesResponse: {
            profiles: components["schemas"]["QualityProfileOption"][];
        };
        IndexerCategoryOption: {
            /** @description The newznab category id a search filter takes. */
            id: number;
            name: string;
        };
        IndexerCategoriesResponse: {
            categories: components["schemas"]["IndexerCategoryOption"][];
        };
...
export interface operations {
    ...
    listQualityProfileOptions: {
        parameters: {
            query?: never;
            header?: never;
            path: {
                /** @description Which *arr to read the profiles from. */
        ...
        requestBody?: never;
        responses: {
            /** @description The quality profiles the service reports. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The service refused or could not answer the lookup. */
            502: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The service is not configured yet. */
            503: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listIndexerCategoryOptions: {
        ...
        requestBody?: never;
        responses: {
            /** @description The categories available as search filters. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["IndexerCategoriesResponse"];
                };
            };
            /** @description Authentication required. */
            401: {
    ...
    listDownloadCategoryOptions: {
        ...
        requestBody?: never;
        responses: {
            /** @description The categories the download client reports. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["DownloadCategoriesResponse"];
                };
            };
            /** @description Authentication required. */
            401: {
