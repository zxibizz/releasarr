...
const mockSeriesRequests: SeriesRequest[] = [
  {
    ...
    season_number: 1,
    total_episodes: 7,
    episode_counts: { downloaded: 7, pending: 0, unaired: 0 },
  ...
  },
  {
    ...
    season_number: 2,
    total_episodes: 13,
    episode_counts: { downloaded: 3, pending: 10, unaired: 0 },
    series_title: 'Breaking Bad',
    series_year: 2008,
    poster_url: 'https://image.tmdb.org/t/p/w500/ggFHVNu6YYI5L9pCfOacjizRGt.jpg',
    overview:
  ...
  },
  {
    ...
    season_number: 2,
    total_episodes: 8,
    episode_counts: { downloaded: 2, pending: 3, unaired: 3 },
...
const mockReleases: Release[] = [
  ...
  {
    id: 'r8',
    name: 'Dune.Part.Two.2024.1080p.WEB-DL-GALAXY',
    hash: 'h8i9j0k1l2m3n4o5p6q7r8s9t0u1v2w3x4y5z6a7',
    size: 12000000000,
    files: [
      {
        id: 'f17',
        name: 'Dune.Part.Two.2024.1080p.WEB-DL-GALAXY.mkv',
        size: 12000000000,
        path: '/downloads/Dune.Part.Two.2024.1080p.WEB-DL-GALAXY/Dune.Part.Two.2024.1080p.WEB-DL-GALAXY.mkv',
      },
    ],
    status: 'completed',
    progress: 100,
    ...
    leechers: 8,
    ratio: 1.1,
    added_date: '2024-01-20T20:00:00Z',
    completed_date: '2024-01-20T21:00:00Z',
    request_ids: ['4'],
    torrent_source: 'GALAXY',
    quality: '1080p',
