"""Fakes shared by the add-request use case tests."""
...
class FakeSonarrService:
    ...
    def __init__(
        ...
        *,
        ...
        self.monitored: list[tuple[int, list[int]]] = []
    ...
    async def set_season_monitoring(
        ...
        self.monitored.append((series_id, list(monitored_seasons)))
...
class FakeRadarrService:
    ...
    async def set_movie_monitored(self, movie_id: int) -> None:
        self.monitored.append(movie_id)
